    ...
    <v-container class="pa-5 py-7" fluid>
        ...
        <v-row>
            ...
            <v-col v-for="sensor in sensors" cols="12" sm="12" lg="6" xxl="4">
                <McuSensorCard 
                    :sensor
                    :loading="sensorCardLoadingIds.includes(sensor.id)"
                >
                    <template #menu>
                        <McuSensorCardMenu 
                            :sensor 
...
const { data: sensors, refresh } = await useFetch<Sensor[]>(`/api/user/greenhouse/${gid}/mcu/${mid}/sensor`, { headers, lazy: true })
