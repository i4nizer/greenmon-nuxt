...
import { OutputUpdateSchema, type OutputUpdate } from "~~/shared/schema/output"
...
// --- Data Binding
const emit = defineEmits<{ submit: [output: OutputUpdate] }>()
const props = defineProps<{ output: OutputUpdate; error?: string; loading?: boolean }>()

// --- Pass Invoke
const update = (values: any) => emit("submit", values as OutputUpdate)
